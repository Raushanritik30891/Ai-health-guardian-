# Generate a clean ResultPage.jsx

path = r"C:\Users\hrthi\Downloads\ahg-v3\frontend\src\pages\check\ResultPage.jsx"

jsx = r"""import React, { useState, useCallback } from 'react'
...
import {
  ...
  ExternalLink, Target, Star, Info, Sparkles
} from 'lucide-react'
...
print(f"Written {len(jsx)} chars to {path}")
